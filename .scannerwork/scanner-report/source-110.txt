...
urlpatterns = [
    ...
    path('display_detail/<str:patient_identifier>',views.display_detail.as_view(),name="display_detail"),
    ...
    path('manage_schedule/<str:practitioner_identifier>', views.schedule.as_view(), name="schedule"),
    path('manage_schedule/', views.manage_schedule.as_view(), name="manage_schedule"),
    path('manage_tests/', views.manage_tests.as_view(), name="manage_tests"),
    path('manage_images', views.manage_images.as_view(), name="manage_images"),
