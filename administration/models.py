...
class ClinicalDepartment(models.Model):
    DEPARTMENT_CHOICES = (("lâm sàng", "Lâm sàng"), ("cận lâm sàng", "Cận lâm sàng"))
    ...
    department_type = models.CharField(
        max_length=100, choices=DEPARTMENT_CHOICES, default="lâm sàng"
    )
...
class PractitionerModel(models.Model):
    ...
    department = models.ForeignKey(
        ClinicalDepartment, on_delete=models.SET_NULL, null=True, blank=True
    )
    practitioner_role = models.CharField(
        max_length=100, choices=PRACTITIONER_ROLE_CHOICES, default="doctor"
    )
