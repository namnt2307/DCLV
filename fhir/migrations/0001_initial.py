# Generated by Django 3.0.5 on 2021-11-24 14:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service_status', models.CharField(choices=[('draft', 'Nháp'), ('active', 'Đang hoạt động'), ('on-hold', 'Tạm giữ'), ('revoked', 'Đã thu hồi'), ('completed', 'Hoàn tất'), ('entered-in-error', 'Nhập sai'), ('unknown', 'Không xác định')], default='active', max_length=100)),
