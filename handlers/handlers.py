...
def register_ehr(patient: dict, id_system: str):
    ...
    xml_data = ET.tostring(root, encoding="us-ascii", method="xml",
...
def register_excel(excel_file, id_system: str, ns):
    ...
    if data['Patient'].values():
        identifier = ET.SubElement(root, 'identifier')
        dt.identifier_type(identifier, id_system, '12345', 'usual', {'codes': [
                           {'system': 'http://terminology.hl7.org/CodeSystem/v2-0203', 'code': 'MR'}]})
